...
<aside x-data="{}"
    ...
    <div class="overflow-x-clip">
        <header
            class="flex items-center h-10 px-6 text-white bg-primary-600 fi-sidebar-header ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 lg:shadow-sm">
            <div
            ...
            @if (filament()->isSidebarCollapsibleOnDesktop())
                <x-filament::icon-button color="gray" :icon="$isRtl ? 'heroicon-o-bars-4' : 'heroicon-o-bars-4'" {{-- @deprecated Use `panels::sidebar.expand-button.rtl` instead of `panels::sidebar.expand-button` for RTL. --}} :icon-alias="$isRtl
            ...
            @if (filament()->isSidebarCollapsibleOnDesktop() || filament()->isSidebarFullyCollapsibleOnDesktop())
                <x-filament::icon-button color="gray" :icon="$isRtl ? 'heroicon-o-bars-4' : 'heroicon-o-bars-4'" {{-- @deprecated Use `panels::sidebar.collapse-button.rtl` instead of `panels::sidebar.collapse-button` for RTL. --}} :icon-alias="$isRtl
    ...
    <nav class="flex flex-col flex-grow px-6 py-8 overflow-x-hidden overflow-y-auto bg-white fi-sidebar-nav gap-y-7 ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10"
